...
<div class="main-content">
    <section class="section">
        ...
        <a href="{{ route('laporan.a9') }}" class="btn btn-icon icon-left btn-warning"> Kembali</a>

        <div class="card mt-4">
            <div class="card-body">
                <h6 class="mb-3">Form A9</h6>
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="posisi_pelebaran_kiri">Posisi Pelabaran (Kiri)</label>
                            <input id="posisi_pelebaran_kiri" class="form-control" value="{{ $data->posisi_pelebaran_kiri }}" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="posisi_pelebaran_kanan">Posisi Pelebaran (Kanan)</label>
                            <input id="posisi_pelebaran_kanan" class="form-control" value="{{ $data->posisi_pelebaran_kanan }}" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="pelebaran_kiri_tba">Pelebaran Kiri (TBA)</label>
                            <input id="pelebaran_kiri_tba" class="form-control" value="{{ $data->pelebaran_kiri_tba }}" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="pelebaran_kiri_bhn">Pelebaran Kiri (BHN)</label>
                            <input id="pelebaran_kiri_bhn" class="form-control" value="{{ $data->pelebaran_kiri_bhn }}" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="pelebaran_kiri_sba">Pelebaran Kiri (SBA)</label>
                            <input id="pelebaran_kiri_sba" class="form-control" value="{{ $data->pelebaran_kiri_sba }}" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="pelebaran_kanan_tba">Pelebaran Kanan (TBA)</label>
                            <input id="pelebaran_kanan_tba" class="form-control" value="{{ $data->pelebaran_kanan_tba }}" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="pelebaran_kanan_bhn">Pelebaran Kanan (BHN)</label>
                            <input id="pelebaran_kanan_bhn" class="form-control" value="{{ $data->pelebaran_kanan_bhn}}" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="pelebaran_kanan_sba">Pelebaran Kanan (SBA)</label>
                            <input id="pelebaran_kanan_sba" class="form-control" value="{{ $data->pelebaran_kanan_sba }}" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
