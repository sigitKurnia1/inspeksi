...
@section('title', 'Detail Laporan A6')
@section('content')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Detail Laporan A6</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div>
                    <div class="breadcrumb-item">Detail Laporan A6</div>
                </div>
            </div>

            <a href="{{ route('laporan.a6') }}" class="btn btn-icon icon-left btn-warning"> Kembali</a>

            <div class="card mt-4">
                <div class="card-body">
                    <h6 class="mb-3">Form A6</h6>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="perlengkapan_kode">Perlengkapan (Kode)</label>
                                <input id="perlengkapan_kode" class="form-control" value="{{ $data->perlengkapan_kode }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="perlengkapan_bhn" class="form-control" value="{{ $data->perlengkapan_bhn }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="penerangan_kode" class="form-control" value="{{ $data->penerangan_kode }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="penerangan_bhn" class="form-control" value="{{ $data->penerangan_bhn }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="moveable_kode" class="form-control" value="{{ $data->moveable_kode }}" readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="moveable_bhn">Moveable (BHN)</label>
                                <input id="moveable_bhn" class="form-control" value="{{ $data->moveable_bhn }}" readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="fasilitas_kode">Fasilitas (Kode)</label>
                                <input id="fasilitas_kode" class="form-control" value="{{ $data->fasilitas_kode }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="perkuatan_gorong_kode" class="form-control"
                                    value="{{ $data->perkuatan_gorong_kode }}" readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="perkuatan_gorong_bhn">Perkuatan Gorong (BHN)</label>
                                <input id="perkuatan_gorong_bhn" class="form-control"
                                    value="{{ $data->perkuatan_gorong_bhn }}" readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="lintasan_tba">Lintasan (TBA)</label>
                                <input id="lintasan_tba" class="form-control" value="{{ $data->lintasan_tba }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="lintasan_bhn" class="form-control" value="{{ $data->lintasan_bhn }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="lintasan_sba" class="form-control" value="{{ $data->lintasan_sba }}"
                                    readonly>
                            </div>
                        </div>
                    </div>
